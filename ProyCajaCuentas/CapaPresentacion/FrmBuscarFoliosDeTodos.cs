...
{
    public partial class FrmBuscarFoliosDeTodos : Form
    {
        //-----------------constructor
        public FrmBuscarFoliosDeTodos()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable listaFolios = Socio_BuscarFoliosActivosDeTodosEnReciboListaProductosController( fechaInicio, fechaFin);
