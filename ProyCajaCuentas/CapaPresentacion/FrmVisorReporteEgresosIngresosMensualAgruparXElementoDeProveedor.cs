...
{
    public partial class FrmVisorReporteEgresosIngresosMensualAgruparXElementoDeProveedor : Form
    {

        //---------------------Constructor
        public FrmVisorReporteEgresosIngresosMensualAgruparXElementoDeProveedor()
        {
            InitializeComponent();
            CargarComboBoxAnios();
            ...
            try
            {
                if (EsActivoModuloController(43)) { /*El button exportar a excel esta habilitado*/ }
        ...
        private Hashtable ObtenerTextObjectsDeCrystalReport(CRReporteEgresosIngresosMensualAgrupXElementoDProveedor crReporte)
        {
            Hashtable tablaHash = new Hashtable();
        ...
        private Hashtable ObtenerFormulaFieldDefinitionDeCR(CRReporteEgresosIngresosMensualAgrupXElementoDProveedorPExportar crReporte)
        {
            Hashtable tablaHash = new Hashtable();
        ...
        private void ConfigurarOpcionesDeRPTParaExportacion(CRReporteEgresosIngresosMensualAgrupXElementoDProveedorPExportar reporte, string nomArchivo)
        {
        ...
        private void HabilitarComboBoxYButtons()
        {
            ...
            button2.Enabled = EsActivoModuloController(43) ? true : false;
        }
            ...
            try
            {
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    if (EstaSeleccionadoComboBoxAnioYComBoBoxMes())
                    {
                        ...
                        CRReporteEgresosIngresosMensualAgrupXElementoDProveedorPExportar reporte = new CRReporteEgresosIngresosMensualAgrupXElementoDProveedorPExportar();
        ...
        private async void button1_Click(object sender, EventArgs e)
        {
            try
            {
                if (EstaSeleccionadoComboBoxAnioYComBoBoxMes())
                {
                    ...
                    Hashtable parametrosFechaInicioFechaFin = GenerarParametrosParaReporte();
                    CRReporteEgresosIngresosMensualAgrupXElementoDProveedor reporteEgresosIngresosMensual = new CRReporteEgresosIngresosMensualAgrupXElementoDProveedor();
