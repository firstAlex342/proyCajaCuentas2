...
namespace CapaPresentacion
{
    public partial class FrmInfoCheque : Form
    {
        ...
        {
            bool seCapturoProveedor = TieneAlgoMasQueEspaciosEnBlanco(textBox4.Text);
            bool seCapturoConcepto = TieneAlgoMasQueEspaciosEnBlanco(textBox5.Text);
            ...
            if(seCapturoProveedor && seCapturoConcepto && seCapturoImporte && seCapturoFactura)
            {
            ...
            {
                MostrarMensajeSiNoSeCapturo("Proveedor", seCapturoProveedor);
                MostrarMensajeSiNoSeCapturo("Concepto", seCapturoConcepto);
