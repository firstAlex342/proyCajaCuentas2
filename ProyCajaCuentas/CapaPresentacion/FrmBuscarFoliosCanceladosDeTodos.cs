...
{
    public partial class FrmBuscarFoliosCanceladosDeTodos : Form
    {
        public FrmBuscarFoliosCanceladosDeTodos()
        {
            InitializeComponent();
        }

        //--------------------Methods controllers
        private DataTable Socio_BuscarFoliosCanceladosDeTodosEnReciboListaProductosController(DateTime fechaInicio, DateTime fechaFin)
        {
            ClsSocio clsSocio = new ClsSocio();
            clsSocio.FechaAlta = fechaInicio;
            clsSocio.FechaModificacion = fechaFin;

            return (clsSocio.Socio_BuscarFoliosCanceladosDeTodosEnReciboListaProductos());
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable listaFolios = Socio_BuscarFoliosCanceladosDeTodosEnReciboListaProductosController(fechaInicio, fechaFin);
